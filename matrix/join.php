...
if(isset($_GET['join_user'])){
	...
	if($flag==1){
		// Fetch the level of the under_userid
		$query = mysqli_query($con, "select Level from tree where userid='$under_userid'");
		$result = mysqli_fetch_array($query);
		$under_user_level = $result['Level'];
		$new_user_level = $under_user_level + 1;
		...
		// Insert into Tree with the new level
		$query = mysqli_query($con,"insert into tree(`userid`, `Level`) values('$email', '$new_user_level')");
                	...
                	<div class="col-lg-4">
						...
						<div class="form-group" style="font-size: 20px">
                            ...
                            <div class="form-group" style="font-size:15px">
								...
								-->
								<input type="radio" name="side" value="first"> 1st Position
                                <input type="radio" name="side" value="second"> 2nd Position
								<input type="radio" name="side" value="third"> 3rd Position
                                <input type="radio" name="side" value="fourth"> 4th Position
