          ...
          <div class="col-lg-6 col-12">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4" style="margin-top: 20px ; font-size: 30px"><b>Please Sign In To Droxford Agency!</b></h1>
              </div>
              <form method="post" action="login.php">
                            <fieldset>
                                ...
                                <div class="" style="margin-right: auto;
                                                     ...
                                                     text-align: center;
                                                     font-size: 22px" >
                                                     <a href="register.php">Don't have a agent account? Register Here</a><br /><br />
                                </div> 
                                <!--<div class="" style="margin-right: auto;
                                                     margin-left: auto;
                                                     text-align: center;
